...
def truePositives(reference, candidate):
    return set(reference).intersection(candidate)


def predictedPositives(reference, candidate):
    return set(candidate)


def actualPositives(reference, candidate):
...
def precision(reference, candidate):
    ...
    tp = len(truePositives(reference, candidate))
    pp = len(predictedPositives(reference, candidate))
...
def recall(reference, candidate):
    ...
    tp = len(truePositives(reference, candidate))
    p = len(actualPositives(reference, candidate))
